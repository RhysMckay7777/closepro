          ...
          <div className="container mx-auto mt-20 px-4 pt-6 md:px-6">
            <div className="group relative mx-auto aspect-video max-w-5xl overflow-hidden rounded-2xl border border-black/5 bg-black/10 p-2 shadow-2xl ring-1 ring-black/5 transition-all duration-500 hover:border-orange-400/40 hover:shadow-lg hover:shadow-orange-500/20 hover:ring-orange-500/30 dark:border-white/10 dark:bg-white/3 dark:ring-white/5 dark:hover:border-orange-400/40 dark:hover:ring-orange-500/30">
              <div className="relative h-full w-full overflow-hidden rounded-xl">
                <Image
                  src="/hero.png"
                  alt="ProCloser – AI call analysis and sales coaching dashboard"
                  fill
        ...
        <section className="w-full overflow-hidden bg-white pt-12 pb-24 md:pt-16 md:pb-32 lg:pt-20 lg:pb-40 dark:bg-black/3" id="faq">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mx-auto max-w-4xl space-y-3">
              {[
                { id: '001', q: 'How does ProCloser analyze my calls?', a: 'We transcribe your sales calls (upload audio or paste a transcript), then our AI analyzes them for clarity, objection handling, next steps, and coaching tips. You get actionable feedback and talking points so you can improve every conversation.' },
                { id: '002', q: 'What is AI roleplay and how does it work?', a: 'You pick an offer and we generate AI prospects (easy, realistic, hard, expert). You practice your pitch and objection handling in real time. ProCloser scores your performance and lets you replay and improve before your next real call.' },
